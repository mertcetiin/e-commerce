                            ...
                            <div key={item.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
                                <div className="relative group">
                                    <a className="block relative h-48 rounded overflow-hidden">
                                        ...
                                        <div className="overlay absolute bottom-0 left-0 w-full h-12 bg-white opacity-0 group-hover:opacity-80 cursor-pointer transition-opacity duration-300 flex items-center justify-center">
