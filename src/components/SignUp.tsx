                ...
                <div className="bg-white p-8 rounded-lg shadow-md w-96">
                    ...
                    <form>
                        <div className="mb-4">
                            ...
                            <input type="name" id="name" name="name" className="text-sm w-full p-2 border rounded-md" placeholder="Enter full name" />
                        </div>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            <label htmlFor="password" className="block text-gray-600 text-sm mb-2">Confirm Password</label>
                            <input type="password" id="password" name="password" className="text-sm w-full p-2 border rounded-md" placeholder="Confirm password" />
                        </div>
